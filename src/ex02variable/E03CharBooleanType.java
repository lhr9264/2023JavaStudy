...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		만약 "(Doutble Quotation)으로 감싸면 문자열로 인식하므로 
		String으로 선언해야한다.
		 */
		...
		아스키코드 :1byte로 표현할 수 있는 문자로 영문, 숫자를 십진수로 정의한것을 말한다.
			Ex) A => 65, a => 97로 표현된다.
		유니코드 : 1byte로 표현할 수 없는 문자로 영문과 
		숫자를 제외한 모든 문자(한글,한자 등)를 2byte로 표현한다.
		...
		//싱클쿼테이션으로 감쌋으므로 문자1(아스키코드:49)이 할당
		char ch4 = '1';
		...
		/*
		boolean타입 : true 혹은 false 두가지의 값만 가질수 잇는 자료형으로 산술연산(+,-),
