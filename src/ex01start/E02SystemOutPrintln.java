...
/*
 println() : 내용을 출력한 후 자동응로 줄바꿈 처리한
 print() : 	출력후 줄바꿈 처리를 하지 않는다. 만약 줄바꿈이 필요하면 \n을 추가해야한
 printf() : 	출력내용을 서식에 맞춰서 출력한다. 또한 자체저인 줄바꿈 기능이 없으므로 \n 혹은 %n을 이용해서 줄바꿈한다. 
 			변수를 출력하는 서식문자에는 %d, %f 등이 있다.
 			단, 줄바꿈을 위한 %n은 printf()에서만 사용 할 수 있다.
  */
public class E02SystemOutPrintln {
	...
	public static void main(String[] args) {
		...
		/*
		숫자(정수 혹은 실수)와 문자열 혹은 문자열과 문자열인 경우에는 단순 연결에서 출력한다.
		 */
