...
/*
지역변수 (Local variable)
-변수는 사용범위(Scope)를 가지고있고, 해당 지역내에서만 사용할수있다.
-해당 지역을 벗어나면 즉시 메모리에서 소멸된다.
-기본자료형은 스택(Stack)이라는 메모리를 사용한다.
-Stack은 입구가 하남나 있는 컵과 같은 형태이며, '선입후출'의
특성을 가진다. 또한 Stack은 CPU가 메모리의 생성 및 소멸을 주관한다.
 */
public class E06LocalVariable {
	...
	public static void main(String[] args) {
		...
		/*
		if문의 블럭에서 선언도니 변수 num은 해당 블럭을 벗어나는 순간
