...
public class E04MethodType03_1 {
	...
	public static void main(String[] args) {
			...
			2개의 정수를 인수(Arguments)로 전달한다. */
			myWantSum(s, e);
		}
		/*
		main 메서드에서 호출시 전달한 2개의 정수를 매개변수가 순서대로
		값을 받게된다. 매개변수는 해당 메서드에 즉시 사용할 수 있는
		지역변수가 된다.
		 */
