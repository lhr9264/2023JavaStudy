package ex06array;
/*
배열 : 순차적인 메모리의 공간이 할당되는 형태로써 하낙 ㅏ아니라
...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		//정수형 배열에 Heap영역에 생성된 후 반환된 주소값이 출력된다.
		...
		배열면.length : 해당 배열의 크기를 반환한다. 배열의 크기가
		...
		인스턴스배열 : 기본자료형을 저장하는 배열이 아닌 인스턴스의 참조값을
		 	저장할 목적으로 생성한 배열을 말한다. 사용법은 일반배열과
		 	동일하다.
		 */
		...
		초기값의 갯수를 통해 배여르이 크기를 결정할 수 있다. 따라서 이
		경우에는 크기는 생략하도록 약속되어있다. */
