...
public class E05TwoDimArray02 {
	...
	public static void main(String[] args) {
		...
		/* 초기화 전, 후 두번의 출력을해야하므로 코드의 중복을 제거하기
		 * 위해 출력용 메서드를 정의한 후 필요할때 호출하여 사용한다. */
		showArray(twoArray);
	...
	//2차원배여르이 참조값을 매개변수로 전달받아 전체 원소를 출력한다. 
