...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		문자열이라도 항상 새로운 메모리를 할당하게된다.*/
		String str1 = new String("Hello JAVA");
		String str2 = new String("Hello JAVA");
		
		/* str1, str2는 string 인스턴스의 참조값을 가지고 있으므로
		아래의 비교는 참조값(주소)에 대한 비교를 하게된다. 2개의 인스턴스는
		...
		실제 저장된 문자열의 내용을 비교하도록 정의되어있다. 즉 아래는
		...
		: 더블쿼테이션을 사용한다. 이 경우 내용이 동일하다면 같은 주소를
		사용한다. 즉 새로운 메모리를 할당하지 않는다. 따라서 String
		인스턴스는 주로 방법2를 통해 생성하는것이 좋다.
		 */
		String str3 = "자바개발자";
		String str4 = "자바개발자";
