...
public class E02StringMethod2 {
	...
	public static void main(String[] args) {
		...
		/*
		6] codePointAt(인덱스) : 문자열의 특징 인덱스의 문자를 찾은 후
			아스키코드(유니코드)를 반환한다.
		 */
		...
		/*
		9]format() : 출력형식을 지정하여 문자열로 반환하고 싶을때 사용
			한다. printf()와 사용법은 동일하고, 주로 웹애플리케이션을
			제작할때 사용한다.
		 */
		System.out.println("### 9 ###");
		//print()문은 콘솔에서만 확인 할 수 있다.
		System.out.printf("국어:%d,영어:%d,수학:%d\n",
				81, 92, 100);

		/* 차후 웹애프리케이션 제작에서 이와같이 처리하여 웹브라우저에 출력
		할수 있다. */
